         ...
         <div class="cart-view-area">
           <div class="cart-view-table">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#">Moises</a></td>
                        <td>S/ 64</td>
                      ...
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#">Edredon</a></td>
                        <td>S/ 155</td>
                        <td><input class="aa-cart-quantity" type="number" value="1"></td>
                        <td>S/ 155</td>
                      </tr>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#">Ajuar</a></td>
                        <td>S/ 30</td>
                        <td><input class="aa-cart-quantity" type="number" value="1"></td>
                        <td>S/ 30</td>
                      </tr>
                      <tr>
                        <td colspan="6" class="aa-cart-view-bottom">
                          <div class="aa-cart-coupon">
                            <input class="aa-coupon-code" type="text" placeholder="Cupon">
                            <input class="aa-cart-view-btn" type="submit" value="Aplicar Cupon">
                          </div>
                          <input class="aa-cart-view-btn" type="submit" value="Actualiza tu compra">
                        </td>
                      </tr>
                      </tbody>
                  </table>
             ...
             <div class="cart-view-total">
               ...
               <a href="#" class="aa-cart-view-btn">Realizar pago</a>
             </div>
           </div>
         </div>
       </div>
